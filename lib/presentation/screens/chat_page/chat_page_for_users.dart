...
class ChatScreenForUser extends StatefulWidget {
  final String user_id;

  final int timestamp;
  const ChatScreenForUser({
    Key? key,
  ...
  @override
  _ChatScreenForUserState createState() => _ChatScreenForUserState();
}

class _ChatScreenForUserState extends State<ChatScreenForUser> {
  ...
  @override
  void initState() {
    vehicleDataModel = userHomeController.vehicles
        .firstWhere((element) => element.uid == widget.user_id);
    name = vehicleDataModel.name ?? "Car Agent";
    super.initState();
  }
